...

{
    ...
    'description': """
This is the base module to manage the accounting chart for Nicaragua.
=====================================================================

Agrega una nomenclatura contable para Nicaragua. También icluye impuestos y
la moneda del Quetzal. -- Adds accounting chart for Nicaragua. It also includes
taxes and the Quetzal currency.""",
    ...
    'data': [
        ...
        'data/l10n_ni_chart_post_data.xml',
